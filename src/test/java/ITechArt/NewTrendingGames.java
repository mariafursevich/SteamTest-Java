...
public class NewTrendingGames {
    public SelenideElement selectGameWithMaxDiscountOrPrice() throws InterruptedException {
        Thread.sleep(5000); //знаю, что использовать thread.sleep не самый лучший вариант, но тут без него есть проблемы, возможно сможешь подсказать другой вариант
